  ...
  return (
    <section className="py-20">
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-4xl font-bold inline-block bg-clip-text bg-gradient-to-r text-transparent mb-4">Our Recruitment Process</h2>
          <p className="text-xl text-blue-600">A systematic approach to finding the perfect match</p>
        </motion.div>
            ...
            {steps.map((step, index) => (
              ...
              >
                <motion.div
                  ...
                  className="w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center mb-4 relative z-10"
                >
