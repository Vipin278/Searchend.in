    ...
    <section className="py-20 bg-gray-200 text-white">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-4xl text-black font-bold mb-4">Success Stories</h2>
          <p className="text-xl text-black">Top Positions Achieved Through Our Company</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {positions.map((position, index) => (
            <motion.div
              ...
              className="bg-gray-50 text-black rounded-lg p-6 text-center relative overflow-hidden group"
            >
