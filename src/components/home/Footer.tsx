      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            {/* Cities We Work In */}
            <div className="border-r border-gray-700 md:border-r-0">
            <h3 className="text-xl font-bold mb-4">Cities We Work In</h3>
            ...
            {/* Contact Information */}
            <div className="border-r border-gray-700 md:border-r-0 mt-0 ml-4 mr-10">
            ...
            <div className="text-center text-sm">
                ...
                <p className="text-sm text-gray-500"> Designed and maintained by <a href="https://www.nineztech.com/" className="hover:text-blue-300">NinezTech IT Solutions</a></p>
            </div>
        </div>
      </footer>
    </div>
