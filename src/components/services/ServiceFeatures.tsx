  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-4xl font-bold inline-block bg-clip-text bg-gradient-to-r text-transparent mb-4">Why Choose Us</h2>
          <p className="text-xl text-blue-600">Experience the difference with our premium staffing services</p>
        </motion.div>
